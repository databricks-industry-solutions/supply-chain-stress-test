...
class MessageHandler:
    ...
    def create_message(self, message_id: str, content: str, role: str, session_id: str, user_id: str, 
                      ...
                      metrics: Optional[dict] = None, is_first_message: bool = False, trace_id: Optional[str] = None, 
                      tool_calls: Optional[list] = None) -> MessageResponse:
        ...
        try:
            ...
            if "duplicate key" in str(e).lower() or "unique constraint" in str(e).lower():
                ...
                logger.info(f"Message {message_id} already exists, updating instead")
    ...
    def update_message(self, session_id: str, message_id: str, user_id: str, 
                      ...
                      metrics: Optional[dict] = None, tool_calls: Optional[list] = None) -> MessageResponse:
